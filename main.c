...
uint8_t top_me_buf[ENCODE_BUFFER_COUNT][2][400 * 240 / RP_ME_MIN_BLOCK_SIZE / RP_ME_MIN_BLOCK_SIZE / 4];
uint8_t bot_me_buf[ENCODE_BUFFER_COUNT][2][320 * 240 / RP_ME_MIN_BLOCK_SIZE / RP_ME_MIN_BLOCK_SIZE / 4];
